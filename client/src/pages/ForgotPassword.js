          ...
          <div className="space-y-6 text-white">
            ...
            <div className="space-y-4 pt-8">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-white">Quick & Secure</h3>
                  <p className="text-blue-200 text-sm">Receive a verification code instantly via email</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 rounded-full p-2 mt-1">
                ...
                <div>
                  <h3 className="font-semibold text-white">Protected Account</h3>
                  <p className="text-blue-200 text-sm">Your account security is our top priority</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 rounded-full p-2 mt-1">
                ...
                <div>
                  <h3 className="font-semibold text-white">Time-Limited Code</h3>
                  <p className="text-blue-200 text-sm">Verification code expires in 10 minutes</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p className="text-blue-700">
                    If you don't receive the email, check your spam folder or contact support@medsecure.com
                  </p>
                </div>
              </div>
            </div>
